...
const CartPage = () => {
  ...
  return (
    <div className="bg-stone-50 min-h-screen pb-12">
      <div className="max-w-4xl mx-auto pt-6 sm:pt-8 px-4 sm:px-6">
        ...
        {/* Summary */}
        <div className="mt-8 bg-white rounded-xl shadow-sm border border-stone-100 p-5 sm:p-6">
          <div className="space-y-3 mb-6">
            ...
            <div className="border-t border-stone-200 pt-3 flex justify-between items-center">
              <span className="text-lg sm:text-xl font-bold text-slate-800">{t("cart.total")}</span>
              <span className="text-xl sm:text-2xl font-bold text-amber-600">¥{cartTotal.toLocaleString()}</span>
            </div>
          </div>
